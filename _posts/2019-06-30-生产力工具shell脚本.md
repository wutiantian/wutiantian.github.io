...
官方说明示例网站： https://stringr.tidyverse.org/articles/regular-expressions.html

正则表达是通用的语言，适用于多种语法，例如：JAVA、Python等。
正则表达式用途主要用于过滤筛选出目标数据结果，其中“爬虫技术”是最为常见的应用，因为要对爬取的数据进行过筛子。
